...
- Implementation status is tracked in the project's Beads (bd) system; see [/.beads/README.md](../../.beads/README.md) and [AGENTS.md](../../AGENTS.md) for details
...
|CMS/PKCS#7|[go-cms](https://github.com/agentic-research/go-cms) (external)|OpenSSL compatible       |
...
Security issues should be reported via GitHub's private vulnerability reporting:
https://github.com/agentic-research/signet/security/advisories/new
